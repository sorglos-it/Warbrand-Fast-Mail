...
FR = {
 ...
 'CFG_DROPHERE': "Glissez un objet sur la liste", 'CFG_CLEAR': "Vider", 'CFG_CLEARCONFIRM': "Supprimer les |cffffff00%d|r entrees de cette liste ?", 'CFG_CLEARTIP': "Vide toute la liste. Pour retirer une seule entree, utilisez la x rouge de sa ligne.",
...
ES = {
 ...
 'CFG_DROPHERE': "Arrastra un objeto a la lista", 'CFG_CLEAR': "Vaciar", 'CFG_CLEARCONFIRM': "Eliminar las |cffffff00%d|r entradas de esta lista?", 'CFG_CLEARTIP': "Vacia toda la lista. Para quitar una sola entrada usa la x roja de su fila.",
...
IT = {
 ...
 'CFG_DROPHERE': "Trascina un oggetto sulla lista", 'CFG_CLEAR': "Svuota", 'CFG_CLEARCONFIRM': "Rimuovere tutte le |cffffff00%d|r voci da questa lista?", 'CFG_CLEARTIP': "Svuota l'intera lista. Per togliere una singola voce usa la x rossa nella riga.",
