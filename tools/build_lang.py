...
NEW = {
 'enUS': {
  ...
  'CFG_CLEARCONFIRM': "Remove all |cffffff00%d|r entries from this list?",
  'CFG_CLEARTIP':   "Empties the whole list. To remove a single entry use the red x on its row.",
 ...
 'deDE': {
  ...
  'CFG_CLEARCONFIRM': "Alle |cffffff00%d|r Eintraege aus dieser Liste entfernen?",
  'CFG_CLEARTIP':   "Leert die ganze Liste. Einzelne Eintraege entfernt das rote x in der Zeile.",
...
FR = {
 ...
 'CFG_DROPHERE': "Glissez un objet ici ou collez un lien / ID", 'CFG_CLEAR': "Vider", 'CFG_CLEARCONFIRM': "Supprimer les |cffffff00%d|r entrees de cette liste ?", 'CFG_CLEARTIP': "Vide toute la liste. Pour retirer une seule entree, utilisez la x rouge de sa ligne.",
...
ES = {
 ...
 'CFG_DROPHERE': "Arrastra un objeto aqui o pega un enlace / ID", 'CFG_CLEAR': "Vaciar", 'CFG_CLEARCONFIRM': "Eliminar las |cffffff00%d|r entradas de esta lista?", 'CFG_CLEARTIP': "Vacia toda la lista. Para quitar una sola entrada usa la x roja de su fila.",
...
IT = {
 ...
 'CFG_DROPHERE': "Trascina qui un oggetto o incolla link / ID", 'CFG_CLEAR': "Svuota", 'CFG_CLEARCONFIRM': "Rimuovere tutte le |cffffff00%d|r voci da questa lista?", 'CFG_CLEARTIP': "Svuota l'intera lista. Per togliere una singola voce usa la x rossa nella riga.",
